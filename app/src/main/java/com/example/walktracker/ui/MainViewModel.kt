...
import com.example.walktracker.data.*
import com.example.walktracker.tracking.LocationService
import com.example.walktracker.tracking.TrackingStats
import com.example.walktracker.util.StepCounter
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val dataStore = androidx.datastore.preferences.preferencesDataStore(context)
